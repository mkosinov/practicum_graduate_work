...
class ReplyGenerator:
    ...
    def hello_first_time():
        return random.choice(
            [
                "Здравствуйте! Я помогу вам найти информацию о фильмах и персонах. Вы можете меня спросить, к примеру, Кто снимался в фильме матрица 2003 года? Или, как называется фильм где джедаи спасают галактику? Если вы захотите выйти из навыка, скажите просто 'выход' или 'помощь' чтобы вызвать справку по навыку.",
                ...
                "Приветствую! Я готов помочь вам с поиском информации о фильмах и актерах. Вы можете задать мне вопросы вроде: 'Какие актеры снимались в фильме 'Матрица' 2003 года?' или 'Как называется фильм, где джедаи спасают галактику?' Если вам нужна помощь или вы хотите выйти из навыка, просто скажите 'помощь' или 'выход'.",
            ]
        )
    ...
    def hello_again():
        return random.choice(
            [
                "Рад снова видеть вас. Задавайте ваши вопросы или скажите 'выход' или 'помощь'",
    ...
    @staticmethod
    def help():
        return "Задавайте ваши вопросы в свободной форме. Например 'кто снимался в фильме матрица', или 'как называется фильм про избранного'. Также я могу повторить ответ, или ваш последний вопрос. Для этого скажите 'повтори' или 'повтори вопрос'. Для выхода скажите просто 'выход'."
